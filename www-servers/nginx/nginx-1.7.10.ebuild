...
# http_fancyindex (https://github.com/Jamim/ngx-fancyindex/tags , BSD license)
HTTP_FANCYINDEX_MODULE_A="Jamim"
HTTP_FANCYINDEX_MODULE_PN="ngx-fancyindex"
HTTP_FANCYINDEX_MODULE_PV="mim.pw"
HTTP_FANCYINDEX_MODULE_P="${HTTP_FANCYINDEX_MODULE_PN}-${HTTP_FANCYINDEX_MODULE_SHA:-${HTTP_FANCYINDEX_MODULE_PV}}"
HTTP_FANCYINDEX_MODULE_URI="https://codeload.github.com/${HTTP_FANCYINDEX_MODULE_A}/${HTTP_FANCYINDEX_MODULE_PN}/tar.gz/${HTTP_FANCYINDEX_MODULE_PV}"
